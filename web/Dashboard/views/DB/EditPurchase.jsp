                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" value="<%= u.getP_quantity()%>" name="p_quantity" id="customer id" placeholder="">
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" value="<%= u.getP_price()%>" name="p_price" placeholder="Enter date">
                                        </div>
                                    </td>
                                </tr>
